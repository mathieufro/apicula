...
dsp_5a_attrids = {
        ...
        'CASISEL_IREG_CE':       9,
        'CASISEL_IREG_CLK':     10,
        'CASISEL_IREG_RESET':   11,
        'PADDSUB_IREG_CE':      12,
        'PADDSUB_IREG_CLK':     13,
        'PADDSUB_IREG_RESET':   14,
        'ACCSEL_0_IREG_CE':     15,
        'ACCSEL_0_IREG_CLK':    16,
        'ACCSEL_0_IREG_RESET':  17,
        'ACCSEL_1_IREG_CE':     18,
        'ACCSEL_1_IREG_CLK':    19,
        'ACCSEL_1_IREG_RESET':  20,
        'ADDSUB0_IREG_CE':      21,
        'ADDSUB0_IREG_CLK':     22,
        'ADDSUB0_IREG_RESET':   23,
        'ADDSUB1_IREG_CE':      24,
        'ADDSUB1_IREG_CLK':     25,
        'ADDSUB1_IREG_RESET':   26,
        'C_IREG_CE':            27,
        'C_IREG_CLK':           28,
        'C_IREG_RESET':         29,
        'C_PREG_CE':            30,
        ...
        'C_PREG_RESET':         32,
        'ACCSEL_0_PREG_CE':     39,
        'ACCSEL_0_PREG_CLK':    40,
        'ACCSEL_0_PREG_RESET':  41,
        'ACCSEL_1_PREG_CE':     42,
        'ACCSEL_1_PREG_CLK':    43,
        'ACCSEL_1_PREG_RESET':  44,
        'ADDSUB0_PREG_CE':      45,
        'ADDSUB0_PREG_CLK':     46,
        'ADDSUB0_PREG_RESET':   47,
        'ADDSUB1_PREG_CE':      48,
        'ADDSUB1_PREG_CLK':     49,
        'ADDSUB1_PREG_RESET':   50,
        'CASISEL_PREG_CE':      51,
        'CASISEL_PREG_CLK':     52,
        'CASISEL_PREG_RESET':   53,
        'CSEL_PREG_CE':         54,
        'CSEL_PREG_CLK':        55,
        'CSEL_PREG_RESET':      56,
        'A1REG_CE':             60,
...
iologic_attrids = {
        ...
        # for n >= 2; step 0 sets no bit and has no row.  Its fuses are eight
        # plain binary weights (tile row 21, columns 3-10 on ttyp 247), so
