"""Fuse attribution: which bits moved, in which tile, for which attr.

Stub created by P0.T18 (`spec-harness.md` §1). Implementation lands in P0.T22.
Module rooting is fixed: this module is always addressed as
`fuzz.gw5ast138c.harness.attribute` and run from `$FL/apicula`; it never depends
...
def main(argv=None):
    """Stub entry point. Implemented by P0.T22."""
    raise NotImplementedError(
        "fuzz.gw5ast138c.harness.attribute.main is a P0.T18 stub; implemented by P0.T22"
    )
