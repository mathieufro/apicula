"""Appends one row per run to the evidence table (`spec-harness.md` §6).

Stub created by P0.T18 (`spec-harness.md` §1). Implementation lands in P0.T28.
Module rooting is fixed: this module is always addressed as
`fuzz.gw5ast138c.harness.evidence` and run from `$FL/apicula`; it never depends
...
def main(argv=None):
    """Stub entry point. Implemented by P0.T28."""
    raise NotImplementedError(
        "fuzz.gw5ast138c.harness.evidence.main is a P0.T18 stub; implemented by P0.T28"
    )
