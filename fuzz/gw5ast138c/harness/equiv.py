"""The equivalence checker (`spec-harness.md` §5).

Stub created by P0.T18 (`spec-harness.md` §1). Implementation lands in P0.T23.
...
def main(argv=None):
    """Stub entry point. Implemented by P0.T23."""
    raise NotImplementedError(
        "fuzz.gw5ast138c.harness.equiv.main is a P0.T18 stub; implemented by P0.T23"
    )
