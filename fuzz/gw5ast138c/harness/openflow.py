"""yosys -> nextpnr-himbaechel -> gowin_pack for the same inputs.

Stub created by P0.T18 (`spec-harness.md` §1). Implementation lands in P0.T21.
...
def main(argv=None):
    """Stub entry point. Implemented by P0.T21."""
    raise NotImplementedError(
        "fuzz.gw5ast138c.harness.openflow.main is a P0.T18 stub; implemented by P0.T21"
    )
