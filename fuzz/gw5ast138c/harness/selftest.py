"""Injects a single known fuse difference and asserts it is found.

Stub created by P0.T18 (`spec-harness.md` §1). Implementation lands in P0.T29.
Module rooting is fixed: this module is always addressed as
`fuzz.gw5ast138c.harness.selftest` and run from `$FL/apicula`; it never depends
...
def main(argv=None):
    """Stub entry point. Implemented by P0.T29."""
    raise NotImplementedError(
        "fuzz.gw5ast138c.harness.selftest.main is a P0.T18 stub; implemented by P0.T29"
    )
